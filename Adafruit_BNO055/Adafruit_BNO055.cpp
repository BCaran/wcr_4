...
bool Adafruit_BNO055::begin(adafruit_bno055_opmode_t mode)
{
  ...
  */
  ...
  // CUSTOM: Set HARDCODED calibration coefficients
  adafruit_bno055_offsets_t hardcoded_offsets;
  hardcoded_offsets.accel_offset_x = -30;
  hardcoded_offsets.accel_offset_y = 15;
  hardcoded_offsets.accel_offset_z = -19;
  hardcoded_offsets.mag_offset_x = -192;
  hardcoded_offsets.mag_offset_y = 12;
  hardcoded_offsets.mag_offset_z = 193;
  hardcoded_offsets.gyro_offset_x = -1;
  hardcoded_offsets.gyro_offset_y = -2;
  hardcoded_offsets.gyro_offset_z = 1;
  hardcoded_offsets.accel_radius = 1000;
  hardcoded_offsets.mag_radius = 721;
  setSensorOffsets(hardcoded_offsets);
