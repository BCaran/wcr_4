...
// MEQ:
#define DXL_ID_HCP 19
#define DXL_ID_GPR_HEIGHT 23
#define DLX_ID_GPR_ROTATION 21
...
//MEQ:
#define MAX_HEIGHT_HCP 2750
#define MIN_HEIGHT_HCP 1450
#define MAX_HEIGHT_GPR 1300
#define MIN_HEIGHT_GPR 725
#define GPR_90_DEG_TO_LEFT 3734  //90 deg
#define GPR_90_DEG_TO_RIGHT 1686 //-90 deg
#define MIDDLE_GPR 2710 //0 deg
#define MAX_HEIGHT_HCP_MM 24.0f     //24mm
#define MIN_HEIGHT_HCP_MM 0.0f      //0mm
#define MAX_HEIGHT_GPR_MM 10.5f     //10.5
#define MIN_HEIGHT_GPR_MM 0.0f      //0 mm
#define GPR_90_DEG_TO_LEFT_DEG 90.0f    //90 deg
#define GPR_90_DEG_TO_RIGHT_DEG -90.0f  //-90 deg
...
public:
    ...
    // MEQ:
    bool setTorqueMeasuringEqMotors (bool onOff_MeqEq);
    bool readEncodersMeasuringEquipment(int32_t meqEqReadPosition[]);
    bool writeMeasuringEquipmentPosition(int64_t writeMeqPostion[]);
    bool setMeasuringEquipmentPosition(double meqGoalPosition[]);
    bool returnCurrentMeasuringEquipementPosition(double meqCurrentPosition[]);
...
private:
    ...
    //MEQ:
    uint8_t HCP_height_id_;
    uint8_t GPR_height_id_;
    uint8_t GPR_rotation_id_;
    ...
    //MEQ:
    //dynamixel::GroupSyncRead *groupSyncReadMeasuringEquipment_;
    dynamixel::GroupSyncWrite *groupSyncWriteMeasuringEquipment_;
