...
ros::Publisher imu_pub("imu_BN055", &imu_msg);
/*******************************************************************************
 * Service
 *******************************************************************************/
...
ros::ServiceServer<std_srvs::TriggerRequest, std_srvs::TriggerResponse> resetIMU_srv("reset_IMU", &IMUresetCallback);
 ...
 *******************************************************************************/
dxlMotorDriverSwerveWMQ motor_driver;
